...
-- Volcando datos para la tabla asistec.asistencias: ~23 rows (aproximadamente)
...
INSERT INTO `asistencias` (`IdAsistencia`, `IdPersonal`, `HorarioEntrada`, `HorarioSalida`, `Observacion`) VALUES
	...
	(8, 8, '2022-01-03 15:08:54', '2022-01-03 15:09:17', '-'),
	(9, 9, '2022-01-03 15:09:12', NULL, '-'),
	(10, 11, '2022-01-03 16:16:18', NULL, '-'),
	(11, 7, '2022-01-04 09:11:17', '2022-01-04 09:12:59', '-'),
	(12, 1, '2022-01-05 19:38:58', '2022-01-05 19:39:00', '-'),
	(13, 1, '2022-01-05 19:39:35', NULL, '-'),
	(14, 6, '2022-01-05 19:39:49', '2022-01-05 19:39:50', '-'),
	(15, 6, '2022-01-05 19:51:01', NULL, '-'),
	(16, 8, '2022-01-05 20:22:35', NULL, '-'),
	(17, 3, '2022-01-06 09:15:10', '2022-01-06 09:18:14', '-'),
	(18, 13, '2022-01-06 09:19:05', NULL, '-'),
	(19, 5, '2022-01-06 09:22:15', '2022-01-06 09:22:16', '-'),
	(20, 15, '2022-01-06 09:22:31', '2022-01-06 09:24:09', '-'),
	(21, 1, '2022-01-06 15:11:52', NULL, '-'),
	(22, 9, '2022-01-06 15:12:01', '2022-01-06 15:12:08', '-'),
	(23, 7, '2022-01-06 15:12:32', NULL, '-');
...
CREATE TABLE IF NOT EXISTS `personal` (
  ...
  `HorasTrabajadas` datetime DEFAULT NULL COMMENT 'Contador de Dias y Horas trabajadas',
...
-- Volcando datos para la tabla asistec.personal: ~15 rows (aproximadamente)
/*!40000 ALTER TABLE `personal` DISABLE KEYS */;
INSERT INTO `personal` (`IdPersonal`, `IdEscuela`, `Apellidos`, `Nombres`, `DNI`, `Estado`, `HorasTrabajadas`) VALUES
	(1, 1, 'Perez', 'Juan', 12564587, 'E', NULL),
	(2, 1, 'Gomez', 'Roberto', 3698456, 'S', NULL),
	(3, 3, 'Ruiz', 'Federico', 36541578, 'S', NULL),
	(4, 2, 'sada', 'sadas', 123, 'S', NULL),
	(5, 3, 'Sosa', 'JOse', 4564654, 'S', NULL),
	(6, 3, 'Gothia', 'Facundo', 56456789, 'S', NULL),
	(7, 3, 'Chehin', 'JUan', 37092016, 'E', NULL),
	(8, 5, 'Lamberti', 'Jorge', 215658775, 'E', NULL),
	(9, 3, 'Morales', 'Mariano', 3702201, 'S', NULL),
	(10, 9, 'Messi', 'Lionel', 25423123, NULL, NULL),
	(11, 1, 'Veron', 'Bruja', 12456457, 'E', NULL),
	(12, 1, 'Dip', 'Hugo', 42157852, 'E', NULL),
	(13, 1, 'Abodacier', 'Roberto', 23121544, 'E', NULL),
	(14, 3, 'Bolati', 'Karelina', 45621157, NULL, NULL),
	(15, 10, 'Batistuta', 'Gabriel', 3554125, 'S', NULL);
